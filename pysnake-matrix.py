...
class PySnake:
    ...
    def printBoard(self):
        ...
        for y in range(self.displayHeight):
            ...
            print out
            # TODO: Change this to output to matrix
    ...
    def handleKeyEvent(self, e):
        if e.name in self.directionDict:
            self.snake.changeDirection(self.directionDict[e.name])
    ...
    def run(self):
        ...
        keyboard.on_press(self.handleKeyEvent)
